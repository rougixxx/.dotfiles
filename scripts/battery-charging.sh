...
case "$BATTERY_STATE" in
	"charging") BATTERY_CHARGING="Battery is Charging" ; BATTERY_ICON="charging" ;;
	"discharging") BATTERY_CHARGING="Battery is Disharging" ; BATTERY_ICON="discharging" ;;
esac

# Send notification
notify-send "${BATTERY_CHARGING}" "${BATTERY_LEVEL}% of battery charged." -u normal -i ~/.dotfiles/icons/battery-${BATTERY_ICON}.png -t 10000 